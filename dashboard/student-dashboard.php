						...
						<div class="rbt-dashboard-content bg-color-white rbt-shadow-box mb--60">
							<div class="content">
										...
										>
											<div class="inner">
												...
												<div class="content">
													...
													<span class="rbt-title-style-2 d-block">Assignments Due</span>
												</div>
											</div>
										</div>
									</div>
										...
										>
											<div class="inner">
												...
												<div class="content">
													...
													<span class="rbt-title-style-2 d-block">Overall Progress</span>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="row g-5 mt--30">
									<div class="col-12">
										<div class="section-title">
											<h4 class="rbt-title-style-3">Current Courses</h4>
										</div>
										<div class="row g-5">
											<!-- Course 1 -->
													...
													<div class="rbt-card-body">
														...
														<div class="rbt-progress-style-1">
															<div class="single-progress">
																<h6 class="rbt-title-style-2">Progress</h6>
																<div class="progress">
																	<div
																		class="progress-bar"
																		role="progressbar"
																...
																<span class="rbt-title-style-2">65%</span>
															</div>
														</div>
														<div class="rbt-card-bottom">
															<a class="rbt-btn btn-sm hover-icon-reverse" href="#">
											...
											<div class="col-lg-4 col-md-6 col-12">
												<div class="rbt-card variation-01 rbt-hover">
													...
													<div class="rbt-card-body">
														...
														<h4 class="rbt-card-title">
															<a href="#">Web Development Basics</a>
														</h4>
														<ul class="rbt-meta">
														...
														<div class="rbt-progress-style-1">
															<div class="single-progress">
																...
																<span class="rbt-title-style-2">15%</span>
															</div>
														</div>
														<div class="rbt-card-bottom">
															<a class="rbt-btn btn-sm hover-icon-reverse" href="#">
												...
												<div class="rbt-card variation-01 rbt-hover">
													...
													<div class="rbt-card-body">
														...
														<ul class="rbt-meta">
															...
															<li><i class="feather-users"></i>35 Students</li>
														</ul>
														<div class="rbt-progress-style-1">
															<div class="single-progress">
																<h6 class="rbt-title-style-2">Progress</h6>
																...
																<span class="rbt-title-style-2">100%</span>
															</div>
														</div>
														<div class="rbt-card-bottom">
															<a class="rbt-btn btn-sm hover-icon-reverse" href="#">
